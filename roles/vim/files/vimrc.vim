...
" Coc plugins
let g:coc_global_extensions = [ 'coc-css', 'coc-emmet', 'coc-fzf-preview',
                              \ 'coc-git', 'coc-highlight', 'coc-html',
                              \ 'coc-jest', 'coc-json', 'coc-pairs',
                              \ 'coc-phpls', 'coc-prettier', 'coc-snippets',
                              \ 'coc-spell-checker', 'coc-stylelint',
                              \ 'coc-tsserver', 'coc-yaml', 'coc-yank' ]
